...
function preload(){
  ...
  groundImage = loadImage("images/moving_ground.png");
...
function setup() {
  ...
  mario = createSprite(100,210,20,50);
  //mario.debug=true
  //mario.colliderRadius=2;
  mario.addAnimation("running", mario_running);

  mario.addAnimation("collided", mario_collided);
  mario.scale = 0.7;
  
  ground = createSprite(200,300,7000,20);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(camera.x+width/2,200,10,40);
    //obstacle.debug = true;
